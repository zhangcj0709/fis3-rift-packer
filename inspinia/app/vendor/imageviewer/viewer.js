...
(function (factory) {
  ...
  var $window = window.parent.$(window.parent);
  var $document = window.parent.$(window.parent.document);
  ...
  Viewer.prototype = {
    ...
    build: function () {
      ...
      //$this.after($viewer); // mod by zcj
      window.parent.$("body").append($viewer); // add by zcj
